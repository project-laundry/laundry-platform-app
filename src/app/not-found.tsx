...
export const metadata: Metadata = {
  title: 'Fant ikke siden – NooraCare',
};

/**
 * Root 404: unmatched URLs and every notFound() call in the app (order, cleaner
 * and admin detail pages). Rendered inside the root layout only, so it brings
 * its own header.
 */
      ...
      <main className="flex flex-1 items-center justify-center px-5 py-10">
        <div className="w-full max-w-md animate-in fade-in slide-in-from-bottom-3 duration-500">
          <div className="rounded-3xl border border-cream-dark/80 bg-warm-white/80 p-6 text-center shadow-[var(--shadow-card)] backdrop-blur sm:p-8">
            ...
            <p className="text-sm font-medium uppercase tracking-[0.18em] text-sea-green">404</p>
            ...
            <p className="mt-3 leading-relaxed text-medium-gray">
              Siden du leter etter finnes ikke, eller lenken er feil.
            </p>
